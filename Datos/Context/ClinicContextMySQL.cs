...
{
    public partial class ClinicContextMySQL : DbContext
    {
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public ClinicContextMySQL() { }

        public ClinicContextMySQL(DbContextOptions<ClinicContextMySQL> options) : base(options) { }

        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
            => optionsBuilder.UseMySql("Server=localhost;Database=ClinicTest;Uid=root;Pwd=andrea2911;", ServerVersion.Parse("8.0.32-mysql"));
