        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Confirm = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValueSql: "((0))"),
                    Reset = table.Column<bool>(type: "tinyint(1)", nullable: false, defaultValueSql: "((0))"),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: false),
                    DateToken = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nit = table.Column<string>(type: "varchar(8)", maxLength: 8, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportNumber = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Description = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Latitude = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Longitude = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Observations = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Path = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Presentation = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    RequestId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(NOW())")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnalysisDocuments_DocumentTypesAnalysis_DocumentTypeAnalysis~",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, true, new DateTime(2023, 10, 21, 17, 26, 27, 196, DateTimeKind.Local).AddTicks(4693), "", "pruebas.test29111999@gmail.com", "51995142", "b20b0f63ce2ed361e8845d6bf2e59811aaa06ec96bcdb92f9bc0c5a25e83c9a6" });

            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Description", "Name", "UpdatedAt", "UpdatedBy" },
                values: new object[] { 1, new DateTime(2023, 10, 21, 17, 26, 26, 639, DateTimeKind.Unspecified), 1, "Administrador", "Administrador", null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 26, 700, DateTimeKind.Unspecified), 1, "Certificación de Muestra Médica", "PE-01", null, null },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 26, 700, DateTimeKind.Unspecified), 1, "Dictamen de Muestra Médica", "PE-02", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Hematología", "HE", null, null },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Química Clínica", "QC", null, null },
                    { 3, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Inmunología", "IN", null, null },
                    { 4, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Microbiología", "MC", null, null },
                    { 5, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Serología", "SR", null, null },
                    { 6, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Hormonas", "HM", null, null },
                    { 7, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Genética y Biología Molecular", "GB", null, null },
                    { 8, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Citología", "CT", null, null },
                    { 9, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Microbiología", "MC", null, null },
                    { 10, new DateTime(2023, 10, 21, 17, 26, 26, 661, DateTimeKind.Unspecified), 1, "Gases en Sangre", "GS", null, null }
                });

            migrationBuilder.InsertData(
                table: "Modules",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "Description", "Image", "Name", "Path", "UpdatedAt", "UpdatedBy" },
                values: new object[] { 1, new DateTime(2023, 10, 21, 17, 26, 26, 633, DateTimeKind.Unspecified), 1, "Mantenimiento de usuarios", "users", "Mantenimiento Analistas", "/Users", null, null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 26, 650, DateTimeKind.Unspecified), 1, "Creada", "Cr", null, null },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 26, 650, DateTimeKind.Unspecified), 1, "Enviada", "EN", null, null },
                    { 3, new DateTime(2023, 10, 21, 17, 26, 26, 650, DateTimeKind.Unspecified), 1, "Revisada", "RV", null, null },
                    { 4, new DateTime(2023, 10, 21, 17, 26, 26, 650, DateTimeKind.Unspecified), 1, "Análisis", "AN", null, null },
                    { 5, new DateTime(2023, 10, 21, 17, 26, 26, 650, DateTimeKind.Unspecified), 1, "Asignada", "AS", null, null },
                    { 6, new DateTime(2023, 10, 21, 17, 26, 26, 650, DateTimeKind.Unspecified), 1, "Autorizada", "AU", null, null },
                    { 7, new DateTime(2023, 10, 21, 17, 26, 26, 650, DateTimeKind.Unspecified), 1, "Rechazada", "RE", null, null },
                    { 8, new DateTime(2023, 10, 21, 17, 26, 26, 650, DateTimeKind.Unspecified), 1, "Eliminada", "EL", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 26, 625, DateTimeKind.Unspecified), 1, "", "Manager", null, null },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 26, 625, DateTimeKind.Unspecified), 1, "", "Centralizador", null, null },
                    { 3, new DateTime(2023, 10, 21, 17, 26, 26, 625, DateTimeKind.Unspecified), 1, "", "Técnico", null, null },
                    { 4, new DateTime(2023, 10, 21, 17, 26, 26, 625, DateTimeKind.Unspecified), 1, "", "Analista", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 26, 672, DateTimeKind.Unspecified), 1, "Cultivo", "CL", null, null },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 26, 672, DateTimeKind.Unspecified), 1, "Plaquetas", "PL", null, null },
                    { 3, new DateTime(2023, 10, 21, 17, 26, 26, 672, DateTimeKind.Unspecified), 1, "Eses", "ES", null, null },
                    { 4, new DateTime(2023, 10, 21, 17, 26, 26, 672, DateTimeKind.Unspecified), 1, "Orina", "OR", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 26, 656, DateTimeKind.Unspecified), 1, "Comprobante de Pago", "CP", null, null },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 26, 656, DateTimeKind.Unspecified), 1, "Seguro Médico", "SE", null, null },
                    { 3, new DateTime(2023, 10, 21, 17, 26, 26, 656, DateTimeKind.Unspecified), 1, "Solicitud Médica", "SM", null, null },
                    { 4, new DateTime(2023, 10, 21, 17, 26, 26, 656, DateTimeKind.Unspecified), 1, "Examen Externo", "ET", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 26, 680, DateTimeKind.Unspecified), 1, "Miligramos", "MG", null, null },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 26, 680, DateTimeKind.Unspecified), 1, "Gramos", "GR", null, null },
                    { 3, new DateTime(2023, 10, 21, 17, 26, 26, 680, DateTimeKind.Unspecified), 1, "Mililitros", "MI", null, null }
                });

            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "CreatedAt", "CreatedBy", "DepartmentId", "Name", "RolId", "UnitId", "UserId", "UserName" },
                values: new object[] { 1, new DateTime(2023, 10, 21, 17, 26, 27, 174, DateTimeKind.Local).AddTicks(8428), 1, 1, "Usuario Manager", 1, 1, 1, "System" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 27, 179, DateTimeKind.Local).AddTicks(8495), "Creación de nuevo analista", "plus", 1, true, "Crear Analista", "/User/Create" },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 27, 180, DateTimeKind.Local).AddTicks(66), "Actualización de analista", "", 1, false, "Actualizar Analista", "/User/Update" },
                    { 3, new DateTime(2023, 10, 21, 17, 26, 27, 180, DateTimeKind.Local).AddTicks(1609), "Listado de Analistas Existentes", "", 1, true, "Listar Analistas", "/User" },
                    { 4, new DateTime(2023, 10, 21, 17, 26, 27, 180, DateTimeKind.Local).AddTicks(2478), "Actualización de analista", "", 1, false, "Actualizar Analista Parcialmente", "/User/Patch" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 10, 21, 17, 26, 27, 186, DateTimeKind.Local).AddTicks(7712), 1, 1 },
                    { 2, new DateTime(2023, 10, 21, 17, 26, 27, 187, DateTimeKind.Local).AddTicks(642), 2, 1 },
                    { 3, new DateTime(2023, 10, 21, 17, 26, 27, 187, DateTimeKind.Local).AddTicks(2018), 3, 1 },
                    { 4, new DateTime(2023, 10, 21, 17, 26, 27, 187, DateTimeKind.Local).AddTicks(3883), 4, 1 }
                });
